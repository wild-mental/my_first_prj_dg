...
ALTER TABLE drink_order2 ADD COLUMN order_status VARCHAR(10);
ALTER TABLE drink_order2 modify column id INT AUTO_INCREMENT;

INSERT INTO drink_order2 (id, customer_id, ordered_at, total_amount, order_status) VALUES
...
SELECT id,
       ...
       CASE
           ...
           ELSE 'Unknown status'
       END AS status_description
FROM drink_order2;  -- 동등비교 외에도 무궁무진한 활용!!